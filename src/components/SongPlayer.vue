<template>
    ...
    <div class="text-white">
        <div class="flex flex-row justify-between text-center">
            ...
            <div class="text-white font-bold m-auto">New Playing</div>
        </div>
        <div>
            <router-link to="/lirik">
            <img class="rounded-xl mt-8 mb-4 mx-auto" v-bind:src="song.image" />
            </router-link>
            <div class="text-center">
                <p class="text-white font-bold text-left">{{ song.title }}</p>
                <p class="text-gray-200 text-left">{{ song.artist }}</p>
            </div>
            ...
            <div class="bg-teal- p-2 rounded-xl">
        ...
        <div class="bg-slate-600 rounded-lg shadow-lg mb-4 max-w-xs text-center">
        <div class="p-4 overflow-y-auto max-h-32">
            <p class="text-left">apa</p>
        </div>
        </div>
                ...
                <div class="flex items-center w-full">
                    <div class="w-full">
                        <div class="flex items-center justify-center mx-auto mb-1">
                            ...
                            <button  data-tooltip-target="tooltip-previous" type="button" class="p-2.5 group rounded-full hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-600 dark:hover:bg-gray-600" v-on:click="previous">
                            ...
                            <button data-tooltip-target="tooltip-pause" type="button" class="inline-flex items-center justify-center p-2.5 mx-2 font-medium bg-white rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800" @click="togglePlay">
